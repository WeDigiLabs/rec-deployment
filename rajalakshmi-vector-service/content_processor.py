...
class ContentProcessor:
    ...
    def _process_dynamic_table_section(self, section: Dict[str, Any], department: str, section_title: str, section_idx: int) -> List[ContentChunk]:
        """Process dynamic table section"""
        # Similar to _process_table_section but for dynamic tables
        return self._process_table_section(section, department, section_title, section_idx)
    ...
    def _process_multiple_tables_section(self, section: Dict[str, Any], department: str, section_title: str, section_idx: int) -> List[ContentChunk]:
        """Process multiple tables section"""
        chunks = []
        tables = section.get('tables', [])
        
        for table_idx, table in enumerate(tables):
            table_chunks = self._process_table_section(table, department, section_title, f"{section_idx}-{table_idx}")
